...
(function () {
  ...
  var SPRITE = '<svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true">' +
    ...
    sym('i-store','<path d="M4 4h16l1 5a2.5 2.5 0 0 1-5 .3A2.5 2.5 0 0 1 11 9.3 2.5 2.5 0 0 1 6 9L3 9z" transform="translate(0 0)"/><path d="M4 9v11h16V9"/><path d="M9 20v-6h6v6"/>') +
